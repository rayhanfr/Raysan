...
import 'dart:convert';
import 'package:biu_project/home_page.dart';
import 'package:biu_project/widgets/dialogs.dart';
...
class _PageLoginState extends State<PageLogin> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: Color.fromARGB(255, 1, 192, 255),
      body: Container(
        ...
        decoration: const BoxDecoration(
          ...
          colors: [Color.fromARGB(255, 29, 141, 239), Color.fromARGB(255, 3, 68, 121)],
        )),
        child: Form(
          key: _formKey,
          child: ListView(
              ...
              Container(
                ...
                child: ElevatedButton.icon(
                    style: ElevatedButton.styleFrom(
                        primary: Color.fromARGB(255, 0, 222, 70),
